...
describe 'the project update path', {:type => :feature} do
  it 'allows a user to change the name of the project' do
    ...
    # click_link('Edit Project') LINE OMITTED DUE TO CONDENSED APP STYLE.
...
describe 'the project delete path', {:type => :feature} do
  it 'allows a user to delete a project' do
    ...
    test_project.save
    id = test_project.id
    # visit "/projects/#{id}/edit" THIS LINE UPDATED, BELOW, DUE TO CONDENSED APP STYLE.
    visit "/projects/#{id}"
    click_button('Delete Project')
    # vist '/' THIS LINE UPDATE, BELOW, TO CORRECT TYPO IN ORIGIONAL TEST.
    visit '/'
